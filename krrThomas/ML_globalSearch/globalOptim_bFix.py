...
from get_calculator import get_calculator
...
class globalOptim():
    ...
    """
    def __init__(self, traj_namebase, MLmodel, startGenerator, mutationSelector, startStructures=None, population_size=5, kappa=2, Niter=50, Ninit=2, sigma=20, Ncand_min=30, min_saveDifference=0.3, minSampleStep=10, dualPoint=False, relaxFinalPop=False):
    ...
    def relaxTrue(self, a):
        ...
        a_relaxed, Erelaxed, Frelaxed = relaxGPAW(a, label)
