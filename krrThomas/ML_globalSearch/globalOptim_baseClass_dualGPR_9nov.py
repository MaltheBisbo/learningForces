...
class globalOptim_baseClass():
    ...
    """
    def __init__(self, traj_namebase, MLmodel_prior, MLmodel_fine, startGenerator, mutationSelector, calc=None, startStructures=None, population_size=5, kappa=2, Niter=50, Ninit=2, Ncand_min=30, min_certainty=0.8, min_distance=0.0, Estd_threshold=10, Nrunning_mean=30, dualPoint=False, errorRelax=False, relaxFinalPop=False):
    ...
    def get_minDistance2data(self, a, MLmodel):
        f_train = MLmodel.featureMat
        f = MLmodel.featureCalculator.get_feature(a)
    ...
    def update_MLrelaxed_pop(self):
        ...
        if self.comm.rank < len(self.population.pop):
            ...
            dmin_temp = self.get_minDistance2data(a_MLrelaxed, self.MLmodel_prior)
    ...
    def newCandidate_beyes(self):
        ...
        for anew_mutated in anew_mutated_list:
            ...
            dmin = self.get_minDistance2data(anew, self.MLmodel_prior)
