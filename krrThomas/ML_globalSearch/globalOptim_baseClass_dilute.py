...
class globalOptim_baseClass():
    ...
    """
    def __init__(self, traj_namebase, MLmodel, startGenerator, mutationSelector, calc=None, startStructures=None, population_size=5, kappa=2, Niter=50, Ninit=2, sigma=20, reg=1e-5, Ncand_min=30, min_certainty=0.8, min_distance=0.0, dualPoint=False, relaxFinalPop=False):
    ...
    def get_minDistance2data(self, a):
        ...
        f = self.MLmodel.featureCalculator.get_feature(a)
