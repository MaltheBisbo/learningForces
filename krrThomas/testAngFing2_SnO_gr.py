...
# Save file
filename = 'SnO_radialFeatures_gauss_Rc1_{}_binwidth1_{}_sigma1_{}.txt'.format(Rc1, binwidth1, sigma1)
try:
...
np.savetxt('SnO_radialResults_gauss_Rc1_{}_binwidth1_{}_sigma1_{}.txt'.format(Rc1, binwidth1, sigma1), result, delimiter='\t')
