...
class krr_class():
    ...
    def __init__(self, comparator, featureCalculator, delta_function=None, reg=1e-5, bias_fraction=0.8, bias_std_add=0.5, **comparator_kwargs):
        ...
        self.length_feature = featureCalculator.Nelements  # featureCalculator.Nbins
    ...
    def predict_energy(self, atoms=None, fnew=None, similarityVec=None, delta_values=None, return_error=False):
        ...
        if similarityVec is None:
            ...
            similarityVec = self.comparator.get_kernelVec(fnew, self.featureMat[:self.Ndata])
    ...
    def train(self, atoms_list=None, data_values=None, featureMat=None, add_new_data=True, k=3, **GSkwargs):
        ...
        **GSkwargs:
        ...
        if add_new_data:
            ...
            self.featureMat = featureMat.reshape((-1, self.length_feature))
            if self.delta_function is not None:
    ...
    def __gridSearch(self, data_values, featureMat, k, delta_values=None, **GSkwargs):
        ...
        for i, sigma in enumerate(sigma_array):
            ...
            similarityMat = self.comparator.get_kernelMat(featureMat)
...
if __name__ == '__main__':
    ...
    from gaussComparator_local import gaussComparator_local
    ...
    featureCalculator = Angular_Fingerprint_local(a_train[0], Rc1=Rc1, Rc2=Rc2, binwidth1=binwidth1, Nbins2=Nbins2, sigma1=sigma1, sigma2=sigma2, gamma=gamma, eta=eta, use_angular=use_angular)

    
    
    # Set up KRR-model
    comparator = gaussComparator_local(Natoms)
