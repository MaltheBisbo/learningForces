...
class krr_class():
    ...
    """
    def __init__(self, comparator, featureCalculator, delta_function=None, reg=1e-5, bias_std_add=0.0, **comparator_kwargs):
    ...
    def predict_force(self, atoms=None, fnew=None, fgrad=None, with_error=False):
        """
        ...
        if with_error:
            ...
            return  -(kernelDeriv.T).dot(self.alpha) - error_force + delta_force
