...
def main():
    ...
    featureCalculator = Angular_Fingerprint(a, Rc1=Rc1, binwidth1=binwidth1, sigma1=sigma1, gamma=gamma, use_angular=False)
    ...
    plt.figure()
    plt.plot(N_array, MAE_test)
    plt.plot(N_array, MAE_test2)
    plt.show()
    """
    plt.figure()
    plt.plot(np.arange(len(fingerprints[0]))*Rc1/len(fingerprints[0]), fingerprints[0], label='index 0')
    plt.plot(np.arange(len(fingerprints[0]))*Rc1/len(fingerprints[0]), fingerprints[10], label='index 10')
    plt.plot(np.arange(len(fingerprints[0]))*Rc1/len(fingerprints[0]), fingerprints[20], label='index 20')
    plt.plot(np.arange(len(fingerprints[0]))*Rc1/len(fingerprints[0]), fingerprints[40], label='index 40')
    plt.plot(np.arange(len(fingerprints[0]))*Rc1/len(fingerprints[0]), fingerprints[80], label='index 80')
    plt.plot(np.arange(len(fingerprints[0]))*Rc1/len(fingerprints[0]), fingerprints[90], label='index 90')
    plt.plot(np.arange(len(fingerprints[0]))*Rc1/len(fingerprints[0]), fingerprints[99], label='index 99')
    plt.legend()
    plt.show()
