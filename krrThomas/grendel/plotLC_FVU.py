...
if __name__ == '__main__':
    path_core1 = 'dataN7_finger_random/LC_finger_random'
    path_core2 = 'dataN7_finger_search/LC_finger_search'
    path_core3 = 'dataN7_finger_search_perm/LC_finger_search_perm'
