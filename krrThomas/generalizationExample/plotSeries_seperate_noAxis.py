...
for i in range(1,Ntrain+1):
    ...
    plt.tick_params(axis='y',
                    ...
                    left=False,
                    labelleft=False)
    plt.savefig('results/3body/seperate_noAxis/TrueContour.pdf', transparent=True)
    ...
    plt.tick_params(axis='y',
                    ...
                    left=False,
                    labelleft=False)
    plt.savefig('results/3body/seperate_noAxis/PredictedContour{}.pdf'.format(i), transparent=True)
    ...
    plt.savefig('results/3body/seperate_noAxis/path{}.pdf'.format(i), transparent=True)
    """
    # Plot bias
    ...
    plt.savefig('results/3body/seperate_noAxis/features{}.pdf'.format(i), transparent=True)
