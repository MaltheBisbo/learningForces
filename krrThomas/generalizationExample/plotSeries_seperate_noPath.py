...
for i in range(1,Ntrain+1):
    ...
    plt.savefig('results/3body/seperate_noPath/TrueContour{}.pdf'.format(i), transparent=True)
    ...
    plt.savefig('results/3body/seperate_noPath/PredictedContour{}.pdf'.format(i), transparent=True)
    ...
    plt.savefig('results/3body/seperate_noPath/path{}.pdf'.format(i), transparent=True)
    """
    # Plot bias
    ...
    plt.savefig('results/3body/seperate_noPath/features{}.pdf'.format(i), transparent=True)
