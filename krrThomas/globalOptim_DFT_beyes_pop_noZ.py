...
class globalOptim():
    ...
    """
    def __init__(self, calculator, traj_namebase, MLmodel=None, population_size=5, kappa=2, Natoms=6, Niter=50, rattle_maxDist=0.5, Nstag=10, min_saveDifference=0.3, minSampleStep=10, Nstart_pop=5, Nperturb=2, noZ=False, dualPoint=False):
