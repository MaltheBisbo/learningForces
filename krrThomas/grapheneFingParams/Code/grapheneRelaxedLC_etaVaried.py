...
np.savetxt('grapheneFingParams/angFing_Rc2_4_Nbins2_30_sigma2_0.2_gamma_1.txt', MAE, delimiter='\t')
...
plt.savefig('grapheneFingParams/results/angLC_Rc2_{0:d}_Nbins2_{1:d}_sigma2_{2:.1f}_gamma_{3:d}.png'.format(Rc2, Nbins2, sigma2, gamma), bbox_inches='tight')
plt.show()
