...
class Angular_Fingerprint(object):
    ...
    def __init__(self, atoms, Rc1=4.0, Rc2=4.0, binwidth1=0.1, Nbins2=30, sigma1=0.2, sigma2=0.10, nsigma=4, eta=1, gamma=3, use_angular=True):
        ...
        """
        cdef double self.Rc1 = Rc1
        cdef double self.Rc2 = Rc2
        cdef double self.binwidth1 = binwidth1
        cdef int self.Nbins2 = Nbins2
        cdef double self.binwidth2 = np.pi / Nbins2
        cdef double self.sigma1 = sigma1
        cdef double self.sigma2 = sigma2
        cdef intttt self.nsigma = nsigma
        cdef double self.eta = eta
        cdef double self.gamma = gamma
